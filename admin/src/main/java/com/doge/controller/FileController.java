...
import com.doge.entity.enums.FileUploadTypeEnum;
import com.doge.entity.enums.ImportTemplateTypeEnum;
...
import com.doge.utils.ScaleFilter;
    ...
    public ResponseVO uploadFile(MultipartFile file, Integer type) {
        ...
        try {
            ...
            if (uploadTypeEnum != null) {
                ScaleFilter.createThumbnail(localFile, uploadTypeEnum.getMaxLength(), uploadTypeEnum.getMaxLength(), localFile);
            }
        } catch (IOException e) {
